...
use tmir_instrs::{BinOp, CastOp, CmpOp, Instr, InstrNode, SwitchCase, UnOp, Operand};
            ...
            TmirBlock {
                ...
                body: vec![
                    ...
                    InstrNode {
                        instr: Instr::Br {
                            target: BlockId(1),
                            args: vec![Operand::Value(ValueId(8)), Operand::Value(ValueId(6))],
                        },
                        results: vec![],
                        proofs: vec![],
                    },
...
fn build_load_store() -> TmirFunction {
    TmirFunction {
        ...
        ty: FuncTy {
            params: vec![Ty::ptr(Ty::int(32)), Ty::int(32)],
            returns: vec![],
        },
        entry: BlockId(0),
        blocks: vec![TmirBlock {
            ...
            body: vec![
                ...
                InstrNode {
                    instr: Instr::Select {
                        ...
                        true_val: Operand::Value(ValueId(1)),
                        false_val: Operand::Value(ValueId(0)),
                    },
                    results: vec![ValueId(4)],
                    proofs: vec![],
                },
...
fn build_gep() -> TmirFunction {
    TmirFunction {
        ...
        ty: FuncTy {
            params: vec![Ty::ptr(Ty::int(32)), Ty::int(64)],
            returns: vec![Ty::int(32)],
        },
        entry: BlockId(0),
        blocks: vec![TmirBlock {
...
fn build_gep_with_offset() -> TmirFunction {
    TmirFunction {
        ...
        ty: FuncTy {
            params: vec![Ty::ptr(Ty::int(64)), Ty::int(64)],
            returns: vec![Ty::int(32)],
        },
        entry: BlockId(0),
        blocks: vec![TmirBlock {
